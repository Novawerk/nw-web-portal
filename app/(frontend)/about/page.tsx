    ...
    <>
      <section className="pt-20 pb-24 md:pt-32">
        <Container>
          ...
          <Reveal delay={0.25}>
            <p className="mt-12 max-w-2xl text-lg leading-relaxed text-mute md:text-xl">
      ...
      <section className="border-t border-border/60 py-24">
        <Container>
          <div className="grid gap-12 md:grid-cols-12">
            ...
            <div className="space-y-4 text-lg leading-relaxed text-mute md:col-span-7 md:col-start-6">
              ...
              <ul className="space-y-3 pl-0">
                <li className="flex gap-4 border-t border-border/60 pt-3">
                  <span className="text-mute-foreground">→</span>
        ...
        <Container>
          ...
          <div className="grid gap-px overflow-hidden rounded-2xl bg-border md:grid-cols-3">
            {principles.map((p, i) => (
              ...
              >
                <span className="font-mono text-xs text-mute">{p.num}</span>
