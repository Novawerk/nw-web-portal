      ...
      <section className="border-t border-border/60 py-24">
        <Container>
          <div className="grid gap-12 md:grid-cols-12">
            ...
            <div className="space-y-6 text-lg leading-relaxed text-muted md:col-span-7 md:col-start-6">
              <p>
...
function ProjectCard({
  ...
  return (
    <div className="group relative flex aspect-[4/3] flex-col justify-end overflow-hidden rounded-2xl border border-border bg-card p-8 transition-transform hover:scale-[1.01]">
